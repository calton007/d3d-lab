...
Cube::Cube(IDirect3DDevice9* device)
{
	...
	// fill in vertex data
	v[0] = Vertex(-3.0f, 1.0f, -3.0f, 0.0f, 0.0f);
	v[1] = Vertex(-3.0f,  3.0f, -3.0f, 0.0f, 1.0f);
	v[2] = Vertex( -1.0f,  3.0f, -3.0f,  1.0f, 1.0f);
	v[3] = Vertex( -1.0f, 1.0f, -3.0f, 1.0f, 0.0f);
	v[4] = Vertex(-3.0f, 1.0f, -1.0f, 1.0f, 1.0f);
	v[5] = Vertex( -1.0f, 1.0f, -1.0f,  0.0f, 1.0f);
	v[6] = Vertex( -1.0f,  3.0f, -1.0f,0.0f, 0.0f);
	v[7] = Vertex(-3.0f,  3.0f, -1.0f,  1.0f, 0.0f);
	_vb->Unlock();
...
{if( world ){
	D3DXMATRIX R;
	   D3DXMatrixTranslation(&R,-2.0f,2.0f,-2.0f);
		D3DXMATRIX p =  R;
