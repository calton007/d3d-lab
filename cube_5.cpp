...
Cube::Cube(IDirect3DDevice9* device)
{
	...
	*/
	v[0] = Vertex(0.0f, -5.0f, -7.0f, 0.0f, 0.0f);
	v[1] = Vertex(0.0f, -3.0f, -7.0f, 0.0f, 1.0f);
	v[2] = Vertex(2.0f, -3.0f, -7.0f, 1.0f, 1.0f);
	v[3] = Vertex(2.0f, -5.0f, -7.0f, 1.0f, 0.0f);
	v[4] = Vertex(0.0f, -5.0f, -5.0f, 1.0f, 1.0f);
	v[5] = Vertex(2.0f, -5.0f, -5.0f, 0.0f, 1.0f);
	v[6] = Vertex(2.0f, -3.0f, -5.0f, 0.0f, 0.0f);
	v[7] = Vertex(0.0f,-3.0f, -5.0f, 1.0f, 0.0f);
	_vb->Unlock();
