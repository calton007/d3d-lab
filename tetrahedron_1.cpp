...
Tetrahedron::Tetrahedron(IDirect3DDevice9* device)
{
	...
	// fill vertex data
	v[0] = Vertex(2.0f, 5.0f, -2.0f,0.0f,0.0f);
	v[1] = Vertex(1.0f,  2.0f, -3.0f,0.0f,1.0f);
	v[2] = Vertex(3.0f,  1.0f, -3.0f,1.0f,0.0f);//012

	v[3] = Vertex( 1.0f, 1.0f, -1.0f,0.0f,1.0f);//301
	v[4] = Vertex(3.0f,  1.0f,  -1.0f,1.1f,1.1f);//431,412
	v[5] = Vertex(1.0f,  2.0f, -3.0f,1.0f,0.0f);//1
