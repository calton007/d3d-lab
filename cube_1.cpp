...
bool Setup()
{
	...
	vertices[1] = Vertex(-1.0f, 1.0f, -1.0f, D3DCOLOR_XRGB(255, 0, 0));
	vertices[2] = Vertex(1.0f, 1.0f, -1.0f, D3DCOLOR_XRGB(0, 0, 255));
	vertices[3] = Vertex(1.0f, -1.0f, -1.0f, D3DCOLOR_XRGB(0, 255, 0));
	vertices[4] = Vertex(-1.0f, -1.0f, 1.0f, D3DCOLOR_XRGB(255,0, 0 ));
	vertices[5] = Vertex(-1.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 0, 255));
	vertices[6] = Vertex(1.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 0, 255));
	vertices[7] = Vertex(1.0f, -1.0f, 1.0f, D3DCOLOR_XRGB(0, 0, 255));
