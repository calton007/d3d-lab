...
bool Display(float timeDelta)
{
	...
	Device->SetSamplerState(0, D3DSAMP_MIPFILTER, D3DTEXF_ANISOTROPIC);}//  按上箭头时为各向异性纹理过滤
		if( ::GetAsyncKeyState(VK_DOWN) & 0x8000f )
			{Device->SetSamplerState(0, D3DSAMP_MAGFILTER,0);
	Device->SetSamplerState(0, D3DSAMP_MINFILTER,0);
